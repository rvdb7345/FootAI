...
if __name__ == '__main__':
    ...
    features_to_use = ['total_home_team_price','total_away_team_price','total_home_team_potential',
                       'total_away_team_potential', 'national_game']

    print(fixture_overview_df[features_to_use].info())

    X_train, X_test, y_train, y_test = train_test_split(preprocessing.normalize(fixture_overview_df[features_to_use].values),
